...
export function EmailConfirmedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-card to-muted flex flex-col items-center justify-center px-6">
      ...
      <div className="relative mb-8">
        <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#8B6914] to-[#C9A84C] flex items-center justify-center shadow-xl shadow-[rgba(201,168,76,0.3)]">
      ...
      <p className="text-gray-500 text-center text-base leading-relaxed mb-8 max-w-xs">
        Votre compte <span className="text-primary font-semibold">LocBeauté</span> est maintenant actif.
